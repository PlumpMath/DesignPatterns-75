...
namespace Ex01.DesktopFacebook
{
    public abstract class MyPictureBoxGeneral : PictureBox
    {
        ...
        protected MyPictureBoxGeneral m_NextChain;

        public void SetNext(MyPictureBoxGeneral i_NextChain)
        {
            this.m_NextChain = i_NextChain;
        }

        public abstract MyPictureBoxGeneral HandleRequest(PictureBox i_pictureBoxToSetPhotoTo);
    }
}
